...
export const projects: PortfolioProject[] = [
  ...
  },
  {
    ...
    title: 'Doompedia',
    repoName: 'doompedia',
    description: 'Offline-first Wikipedia discovery for healthier scrolling across web, Android, and iOS.',
    category: 'live',
    status: 'active',
    language: 'Kotlin',
    stack: ['Kotlin', 'Jetpack Compose', 'Swift', 'Static web app', 'Offline data'],
    repoUrl: `${github}/doompedia`,
    liveUrl: 'https://doompedia.elfeel.me',
    updatedAt: '2026-07-03',
    domain: 'doompedia.elfeel.me',
    highlights: ['Offline-first reading', 'Curated discovery loop', 'Shared web and native experience'],
    lessonsLearned: ['Offline information products need fast retrieval, explicit provenance, and strong content boundaries.'],
    featured: false,
  },
  {
    id: 'anubis',
    title: 'Anubis',
    repoName: 'Anubis',
    description: 'Analog-horror ARG built around damaged signals, hand-authored puzzles, and player progression.',
    category: 'experiment',
    status: 'active',
    language: 'TypeScript',
    stack: ['Next.js', 'React', 'TypeScript', 'MongoDB', 'MDX'],
    repoUrl: `${github}/Anubis`,
    liveUrl: 'https://anubis.elfeel.me',
    updatedAt: '2026-07-02',
    domain: 'anubis.elfeel.me',
    highlights: ['Hand-authored puzzle levels', 'Persistent progression', 'Content-driven ARG structure'],
    lessonsLearned: ['ARG-style products need tight content tooling and a coherent visual language.'],
    featured: false,
  },
  {
    id: 'bachelor',
    title: 'MANTA',
    repoName: 'feel-bachelor',
    description: 'Bachelor thesis and Android research prototype for metadata-only mobile network threat detection.',
    category: 'live',
    status: 'featured',
    language: 'Python',
    stack: ['Python', 'Android', 'Kotlin', 'Machine learning', 'Network telemetry'],
    repoUrl: 'https://github.com/Resistine/feel-bachelor',
    liveUrl: 'https://bachelor.elfeel.me',
    updatedAt: '2026-07-03',
    domain: 'bachelor.elfeel.me',
    course: 'Computer Science Bachelor Thesis',
    highlights: ['Payload-private flow analysis', 'On-device anomaly scoring', 'Interactive research demo'],
    lessonsLearned: ['Useful mobile threat signals can come from behavior metadata without inspecting payload contents.'],
    featured: false,
  },
  {
    id: 'tariffguard',
    title: 'TariffGuard',
    repoName: 'TariffGuard',
    description: 'Serverless EV charging tariff validation, session auditing, alerts, and operations reporting.',
    category: 'live',
    status: 'featured',
    language: 'TypeScript',
    stack: ['React', 'TypeScript', 'Python', 'AWS Lambda', 'DynamoDB', 'SQS', 'Terraform'],
    repoUrl: `${github}/TariffGuard`,
    liveUrl: 'https://tariffguard.elfeel.me',
    updatedAt: '2026-07-01',
    domain: 'tariffguard.elfeel.me',
    highlights: ['Idempotent session ingestion', 'Asynchronous tariff validation', 'Daily audit and alert operations'],
    lessonsLearned: ['Serverless workflows need explicit idempotency, decimal-safe billing, and observable async boundaries.'],
    featured: false,
  },
  {
    id: 'rps',
...
export const liveProjectIds = ['portfolio', 'scheduler', 'typeshift', 'doompedia', 'ocpp-demo', 'anubis', 'bachelor', 'tariffguard', 'commit'];
